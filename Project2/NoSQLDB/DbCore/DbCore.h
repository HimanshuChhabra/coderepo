...
namespace NoSqlDb
{
  ...
  */
  ...
  {
    out << "\n  ";
    out << std::setw(45) << std::left << el.name().substr(0, 13);
    out << std::setw(26) << std::left << std::string(el.dateTime());
    out << std::setw(20) << std::left << el.descrip().substr(0, 18);
    out << std::setw(45) << std::left << std::string(el.payLoad()).substr(0, 18);
  ...
  {
    out << "\n  ";
	out << std::setw(45) << std::left << key;//key.substr(0, 13);
    out << std::setw(15) << std::left << el.name().substr(0, 13);
    out << std::setw(26) << std::left << std::string(el.dateTime());
    out << std::setw(20) << std::left << el.descrip().substr(0, 18);
    out << std::setw(45) << std::left << std::string(el.payLoad());
    Children children = el.children();
    if (children.size() > 0)
    {
      out << "\n    child keys: ";
